...
export default function CoatSection() {
  return (
    <div className="space-y-8">
      ...
      <div>
        <p className="text-sm uppercase tracking-[0.2em] text-rc-warm/50 mb-4">How we say it</p>
          ...
          {[
            ...
            <div key={i} className="bg-rc-fog/30 rounded-2xl p-5">
              <div className="flex items-start gap-3 mb-3">
                ...
                <p className="text-lg text-rc-reject/80 italic">{item.instead}</p>
              </div>
              <div className="flex items-start gap-3 mb-3">
                <span className="text-rc-sage text-xs font-semibold mt-0.5">✓</span>
                <p className="text-lg text-rc-bark">{item.we_say}</p>
              </div>
              <p className="text-sm text-rc-warm/70 ml-6">{item.why}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-rc-fog/30 rounded-2xl p-5">
        <div className="flex items-start gap-3 mb-3">
          <span className="text-rc-reject text-xs font-semibold mt-0.5">✗</span>
          <p className="text-lg text-rc-reject/80 italic">&quot;We&apos;re worth every penny!&quot;</p>
        </div>
        <div className="flex items-start gap-3 mb-3">
          <span className="text-rc-sage text-xs font-semibold mt-0.5">✓</span>
          <p className="text-lg text-rc-bark">&quot;Your dog is relaxed during the groom and calm when it&apos;s over. And you don&apos;t even need to make a trip. That&apos;s what the [price] gets you.&quot;</p>
        </div>
        <p className="text-sm text-rc-warm/70 ml-6">Never apologize for the price. Never oversell the luxury. Explain what the dog gets. The experience speaks for itself.</p>
      </div>

      {/* The rule */}
      <div className="bg-rc-cream border border-rc-gold/20 rounded-2xl p-6">
        <p className="text-lg text-rc-bark/90 leading-relaxed">
